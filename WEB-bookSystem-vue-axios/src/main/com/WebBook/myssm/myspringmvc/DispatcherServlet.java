package main.com.WebBook.myssm.myspringmvc;



import main.com.WebBook.myssm.ioc.BeanFactory;
import main.com.WebBook.myssm.util.StringUtil;
            ...
            for(Method method : methods){
                if(operate.equals(method.getName())){
                    ...
                    if (methodReturnStr!=null&&!("".equals(methodReturnStr))) {
                        ...
                        }else if (methodReturnStr.startsWith("json:")){//处理json
